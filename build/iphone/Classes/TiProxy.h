...
//Rare exceptions to indicate a bug in the _stopwatch005 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for stopwatch005 proxies.
 */
