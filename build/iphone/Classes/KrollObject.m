 ...
 * Copyright (c) 2009-2011 by stopwatch005, Inc. All Rights Reserved.
...
//@interface stopwatch005Object : NSObject
//@end

@interface stopwatch005Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[stopwatch005Object class]])
		{
			for (NSString *key in [[(stopwatch005Object*)o modules] allKeys])
			{
