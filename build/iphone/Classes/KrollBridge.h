...
@interface stopwatch005Object : KrollCoverageObject {
#else
@interface stopwatch005Object : KrollObject {
#endif
@private
...
extern NSString * stopwatch005$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	stopwatch005Object *_stopwatch005;
    KrollObject* console;
	BOOL shutdown;
