...
static NSString * const kstopwatch005Javascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_stopwatch005Injection
{
	...
	[html appendString:kstopwatch005Javascript];
...
{
	// attempt to make well-formed HTML and inject in our stopwatch005 bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _stopwatch005Injection]];
