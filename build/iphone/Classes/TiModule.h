...
/**
 The base class for all stopwatch005 modules
 */
...
/**
 stopwatch005 Platform calls this method on startup.
 */
-(void)startup;

/**
 stopwatch005 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 stopwatch005 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 stopwatch005 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 stopwatch005 Platform calls this method on resume.
 @param sender The sender of the event.
 */
