...
// in simulator we redefine to format for stopwatch005 Developer console
...
{\
	NSString * exceptionName = [@"org.stopwatch005." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.stopwatch005";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIstopwatch005NativeItemNone = -1, 
	UIstopwatch005NativeItemSpinner = -2,
	UIstopwatch005NativeItemProgressBar = -3,
	
	UIstopwatch005NativeItemSlider = -4,
	UIstopwatch005NativeItemSwitch = -5,
	UIstopwatch005NativeItemMultiButton = -6,
	UIstopwatch005NativeItemSegmented = -7,
	
	UIstopwatch005NativeItemTextView = -8,
	UIstopwatch005NativeItemTextField = -9,
	UIstopwatch005NativeItemSearchBar = -10,
	
	UIstopwatch005NativeItemPicker = -11,
	UIstopwatch005NativeItemDatePicker = -12,
	
	UIstopwatch005NativeItemInfoLight = -13,
	UIstopwatch005NativeItemInfoDark = -14,
	
	UIstopwatch005NativeItemDisclosure = -15,
	
	UIstopwatch005NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all stopwatch005 instances of
