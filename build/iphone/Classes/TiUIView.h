...
/**
 Base class for all stopwatch005 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the stopwatch005 view hierarchy (such as wrapped iOS UIViews) was touched.
